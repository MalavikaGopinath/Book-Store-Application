...
<body background="img9p.jpg">
	...
	<form name="form" action="OnlinePaymentController" method="get"
		...
		<div class="online" style="text-align: center; color: aqua;">
			...
			<span style="color: red"><h2><%=(request.getAttribute("custid") == null) ? "" : request.getAttribute("custid")%></h2></span><br/>
	...
	<span style="color: red"><b><%=(request.getAttribute("msg2") == null) ? "" : request.getAttribute("msg2")%></b></span><br/>
	<br/><br/>
