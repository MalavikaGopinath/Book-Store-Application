...
<body background="btadmininsertion.jpg">
	...
	<form name="form" action="AdminDeleteController" method="post"
		...
		<div style="text-align: center">
			...
			<table style="display: inline-block" cellspacing="20">
				<tr>
					...
					<td><input type="text" name="bookid"
						value="<%=(request.getAttribute("bookid"))%>" /></td>
				</tr>
				<tr>
			...
			<table style="display: inline-block">
				...
				<tr>
					<td colspan="2"><span style="color: green"><%=(request.getAttribute("succmessage") == null ? "" : request.getAttribute("succmessage"))%></span>
				</tr>
				<tr>
					<td colspan="2"><span style="color: red"><%=(request.getAttribute("failmessage") == null ? "" : request.getAttribute("failmessage"))%></span>
				</tr>
				<tr>
					<td colspan="2"><span style="color: red"><%=(request.getAttribute("cancel") == null ? "" : request.getAttribute("cancel"))%></span>
				</tr>
				<td colspan="2"><span style="color: red"><%=(request.getAttribute("fail") == null ? "" : request.getAttribute("fail"))%></span>
				</tr>
